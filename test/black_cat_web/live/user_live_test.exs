defmodule BlackCatWeb.UserLiveTest do
  use BlackCatWeb.ConnCase

  import Phoenix.LiveViewTest
  import BlackCat.AccountsFixtures

  @create_attrs %{email: "some email", name: "some name", profile: 42}
  @update_attrs %{email: "some updated email", name: "some updated name", profile: 43}
  @invalid_attrs %{email: nil, name: nil, profile: nil}
